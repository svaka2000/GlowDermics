...
function makeStyles(c: Palette) {
  ...
  todayQ: { fontSize: 15, fontWeight: '700', color: c.textPrimary },

  countRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  countBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: c.bgElevated, borderWidth: 1, borderColor: c.border, alignItems: 'center', justifyContent: 'center' },
  countNum: { fontSize: 40, fontWeight: '900', color: c.textPrimary, width: 80, textAlign: 'center' },
  ...
  insightTip: { fontSize: 12, color: c.textSecondary, lineHeight: 18 },

  zoneRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, paddingVertical: 8 },
  zoneBorder: { borderBottomWidth: 1, borderBottomColor: c.border },
  zoneEmoji: { fontSize: 16, width: 22, textAlign: 'center' },
  zoneLabel: { fontSize: 13, fontWeight: '600', color: c.textPrimary },
