...
const styles = StyleSheet.create({
  ...
  scanBtn: { backgroundColor: Colors.primary, borderRadius: 14, paddingHorizontal: 24, paddingVertical: 14, marginTop: 8 },
  ...
  scanCountBadge: { fontSize: 9, fontWeight: '800', letterSpacing: 1.5, color: Colors.primary },
  dateRange: { fontSize: 11, color: Colors.textMuted },
  headline: { fontSize: 20, fontWeight: '800', color: Colors.textPrimary, lineHeight: 28 },
  summary: { fontSize: 14, color: Colors.textSecondary, lineHeight: 22 },

  card: { backgroundColor: Colors.bgCard, borderRadius: 18, borderWidth: 1, borderColor: Colors.border, padding: 18, marginBottom: 14 },
  ...
  insightTitle: { fontSize: 14, fontWeight: '700', color: Colors.gold },
  ...
  stepText: { fontSize: 14, color: Colors.textSecondary, lineHeight: 21, flex: 1 },

  actionsRow: { flexDirection: 'row', gap: 10, marginBottom: 8 },
  actionBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
    backgroundColor: Colors.bgCard, borderRadius: 14,
    borderWidth: 1, borderColor: Colors.borderStrong, paddingVertical: 14,
  },
