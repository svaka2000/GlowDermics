...
const RECOVERY_TIPS = [
  ...
  { tip: 'Recovery protocol', detail: 'Week 1–2: no exfoliants of any kind. Only gentle cleanser and occlusive moisturiser (tallow, ceramide cream, or petrolatum). No actives. Week 3: introduce PHA 1× weekly. Week 4–5: add back gentle AHA or BHA if skin responds well.', icon: '🛡️' },
  ...
  { tip: 'Tallow after exfoliation', detail: 'After chemical exfoliation, the skin surface is temporarily more permeable and slightly compromised. Applying tallow 30–60 minutes after acid (give the acid time to work first) provides immediate barrier support. The tallow\'s ceramide precursors feed into the barrier that the exfoliant temporarily disrupted.', icon: '🌿' },
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Animated.View style={[styles.header, { opacity: headerAnim, transform: [{ translateY: headerAnim.interpolate({ inputRange: [0, 1], outputRange: [-14, 0] }) }] }]}>
        ...
        <Text style={styles.headerTitle}>Exfoliation Guide</Text>
        <View style={{ width: 60 }} />
      </Animated.View>
