...
function buildFacials(c: Palette): FacialType[] {
  return [
  {
    ...
    steps: [
      ...
      { title: 'Apply Occlusive Balm', instruction: 'Warm a pea-sized amount of a rich occlusive balm between your fingers. Press gently into damp skin using upward strokes.', duration: 60, emoji: '✨', product: 'Occlusive balm', tip: 'Applying to damp skin locks in moisture — don\'t fully dry before applying.' },
      { title: 'Massage In', instruction: 'Use your fingertips to gently massage the balm in circular motions. Neck up to forehead. Stimulates circulation and lymphatic drainage.', duration: 90, emoji: '🙌', product: 'Occlusive balm', tip: 'Lymphatic massage reduces puffiness — always move upward and outward.' },
  ...
  },
  {
    ...
    color: ['#1A1A2E', '#16213E'],
    steps: [
      { title: 'Oil Cleanse (Step 1)', instruction: 'Massage a small amount of a balm or facial oil into dry skin. This lifts makeup, sunscreen, and pollutants without stripping.', duration: 90, emoji: '🌿', product: 'Occlusive balm or facial oil', tip: 'Oil cleansing follows "like dissolves like" — oil removes oil-based dirt better than water.' },
      ...
      { title: 'Apply Occlusive Balm', instruction: 'Apply a rich occlusive balm generously as your night treatment. Your skin will absorb it fully as you sleep — wake up to softer, more supple skin.', duration: 60, emoji: '🌿', product: 'Occlusive balm', tip: 'Your skin repairs itself overnight — giving it the occlusive\'s lipids gives it the building blocks it needs.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Nourish & Seal', instruction: 'Apply a slightly more generous layer of a rich occlusive balm than usual. Your freshly cleansed skin is primed to absorb nutrients.', duration: 90, emoji: '🌿', product: 'Occlusive balm', tip: 'Freshly exfoliated and cleansed skin absorbs active ingredients up to 40% better.' },
    ],
  },
  {
    id: 'barrier',
    ...
    steps: [
      ...
      { title: 'Layer the Occlusive', instruction: 'Apply a thick, generous layer of a rich occlusive balm to your entire face and neck. Press firmly — don\'t rub.', duration: 90, emoji: '🌿', product: 'Occlusive balm', tip: 'An occlusive\'s saturated fats mimic the skin\'s own lipids — it rebuilds the barrier from the structural level.' },
      { title: 'Occlude if Needed', instruction: 'For very dry or cracked areas, apply a second layer of balm and leave overnight. This is "slugging" with simple ingredients.', duration: 60, emoji: '💧', product: 'Occlusive balm (extra layer)', tip: 'Occluding damaged skin overnight dramatically speeds barrier recovery.' },
