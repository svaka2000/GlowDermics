...
const TERMS: Term[] = [
  ...
  { term: 'CLA (Conjugated Linoleic Acid)', category: 'Ingredient', definition: 'A fatty acid found abundantly in grass-fed a rich occlusive balm. Has potent anti-inflammatory and anti-proliferative properties. Helps reduce acne and redness when applied topically.', example: 'A rich occlusive balm from grass-fed cattle contains 3-5x more CLA than grain-fed.' },
  { term: 'Comedogenic', category: 'Rating', definition: 'A rating (0-5) describing how likely an ingredient is to clog pores. 0 = non-comedogenic, 5 = highly comedogenic. A rich occlusive balm rates 0-1, making it suitable for acne-prone skin.', example: 'Coconut oil = 4, Jojoba oil = 2, A rich occlusive balm = 0-1' },
  ...
  { term: 'Emollient', category: 'Function', definition: 'An ingredient that softens and smooths skin by filling gaps in the stratum corneum. Oils, butters, and a rich occlusive balm are emollients. Different from humectants (attract water) and occlusives (seal water in).', example: 'Jojoba oil, squalane, tallow' },
  { term: 'Emulsifier', category: 'Chemistry', definition: 'An ingredient that allows water and oil to mix stably, forming a cream or lotion. Many synthetic emulsifiers disrupt the skin\'s natural lipid barrier. Anhydrous (water-free) products like a rich occlusive balm don\'t require emulsifiers.' },
  ...
  { term: 'Linoleic Acid (Omega-6)', category: 'Ingredient', definition: 'An essential fatty acid that skin cannot synthesize itself. Deficiency causes dry, scaly, acne-prone skin. Important for barrier function and sebum composition. Grass-fed a rich occlusive balm is rich in linoleic acid.' },
  ...
  { term: 'Occlusive', category: 'Function', definition: 'An ingredient that creates a physical barrier on skin, preventing transepidermal water loss (TEWL). Used as the final step in skincare to seal in all moisture and actives.', example: 'Petrolatum, a rich occlusive balm, beeswax, zinc oxide' },
  { term: 'Palmitoleic Acid', category: 'Ingredient', definition: 'A monounsaturated omega-7 fatty acid produced by the skin itself. Found abundantly in a rich occlusive balm. Has antimicrobial properties and promotes wound healing. Levels in skin decline significantly with age.' },
  ...
  { term: 'Sebum', category: 'Biology', definition: 'The oily substance produced by sebaceous glands. Its composition — triglycerides, wax esters, squalene, free fatty acids — is closely mimicked by grass-fed a rich occlusive balm, making a rich occlusive balm the most skin-compatible moisturizer.' },
  ...
  { term: 'TEWL (Transepidermal Water Loss)', category: 'Biology', definition: 'The passive movement of water from the body through the epidermis to the environment. Disrupted barriers have elevated TEWL. Measured with a tewameter. Occlusives like a rich occlusive balm significantly reduce TEWL.' },
  ...
  { term: 'Zinc', category: 'Ingredient', definition: 'A mineral essential for wound healing, sebum regulation, and anti-inflammatory activity. Zinc oxide in sunscreens is the gold standard UV blocker. Oral zinc reduces inflammatory acne. A rich occlusive balm naturally contains trace zinc.' },
  { term: 'Occlusivity Index', category: 'Rating', definition: 'An informal measure of how well an ingredient prevents water loss. Petrolatum is the gold standard (occlusive index of ~100%). A rich occlusive balm is 20-30%, jojoba 10-15%. Higher = better barrier sealing.' },
  { term: 'Anhydrous', category: 'Chemistry', definition: 'Literally "without water." Anhydrous products (like pure a rich occlusive balm) don\'t require preservatives since bacteria need water to grow. More stable, longer shelf life, and more concentrated than water-based products.' },
  { term: 'Fatty Acids', category: 'Chemistry', definition: 'Building blocks of fats. Categorized as saturated (solid at room temperature, like a rich occlusive balm), monounsaturated (MUFA), and polyunsaturated (PUFA). Skin relies on specific fatty acids for barrier integrity.' },
